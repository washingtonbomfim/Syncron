...
if($i[0] == NULL){
       ...
       $sql_cadastra_usu =  $conecta->query("INSERT INTO syncron.sync_usuarios(email,senha,nome_completo,login, status)
                        VALUES ('$email','$senha','$nome_completo','$nome', 'P')");
        ...
        mkdir("/opt/$nome/documentos") or die ("erro ao criar diretorio musica");
        mkdir("/opt/$nome/compartilhado") or die ("erro ao criar diretorio compartilhado");
